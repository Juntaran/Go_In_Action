...
// IllegalPairTypeError 代表非法的键值对类型的错误类型
...
// PairRedistributorError代表无法再分布键值对的错误类型
type PairRedistributorError struct {
	msg 	string
}

// newPairRedistributorError会创建一个PairRedistributorError类型的实例
